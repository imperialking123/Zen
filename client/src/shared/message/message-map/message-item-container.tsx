import type { IMessage, IUser } from "@/core/types/schema";
import {
...
import { P2PMessageReplyUI } from "@/shared/message/message-map/message-reply-ui";
...
const MessageTextRenderer = lazy(
  () => import("@/shared/message/message-map/message-text-renderer"),
);

const ShowFullTimeStampTooltip = lazy(
  () => import("@/shared/message/show-full-createdAt-tooltip"),
);

const MessageGifRender = lazy(
  () => import("@/shared/message/message-map/message-gif-render"),
);

const MessageAttachmentRenderer = lazy(
  () => import("@/shared/message/message-map/attachment/message-attachment-render"),
);
